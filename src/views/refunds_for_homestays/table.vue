	...
	<el-row class="rows row2">
		...
		<el-col :xs="24" :sm="24" :lg="24" class="search_btn_wrap search_btns">
				...
				<el-col :xs="24" :sm="10" :lg="8" class="search_btn_1 search_btn_wrap_1 btns">
						...
						<el-button v-if="user_group == '管理员' || $check_action('/refunds_for_homestays/table','del') || $check_action('/refunds_for_homestays/view','del')" class="search_btn_del" type="danger" @click="delInfo()">删除</el-button>
		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
			...
			<el-table-column fixed="right" label="操作" min-width="200" v-if="user_group == '管理员' || $check_action('/refunds_for_homestays/table','set') || $check_action('/refunds_for_homestays/view','set') || $check_action('/refunds_for_homestays/view','get') || $check_action('//table','add') || $check_action('//view','add')" >


				<template slot-scope="scope">
					<div class="view_a">
					<router-link class="e-button el-button--small is-plain el-button--success" style="margin: 5px !important;"
					v-if="user_group == '管理员' || $check_action('/refunds_for_homestays/table','set') || $check_action('/refunds_for_homestays/view','set') || $check_action('/refunds_for_homestays/view','get')"
	...
	export default {
		...
		data() {
			return {
				...
				showModal: false,
				// 获取数据地址
				url_get_list: "~/api/refunds_for_homestays/get_list?like=0",
				url_del: "~/api/refunds_for_homestays/del?",
