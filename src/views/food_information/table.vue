		...
		<el-form label-position="right" :model="query" class="form p_4" label-width="120">
			<el-row class="rows row1">
					...
					<el-form-item label="美食分类">
									<el-select v-model="query.food_classification">
		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
			<el-table-column fixed type="selection" tooltip-effect="dark" width="55">
				...
				v-if="user_group == '管理员' || $check_field('get','food_classification')" min-width="200">
					...
					<el-table-column prop="food_address" @sort-change="$sortChange" label="美食地址"
				v-if="user_group == '管理员' || $check_field('get','food_address')" min-width="200">
					</el-table-column>
					<el-table-column prop="food_labels" @sort-change="$sortChange" label="美食标签"
				v-if="user_group == '管理员' || $check_field('get','food_labels')" min-width="200">
					</el-table-column>
			...
			<el-table-column fixed="right" label="操作" min-width="200" v-if="user_group == '管理员' || $check_action('/food_information/table','set') || $check_action('/food_information/view','set') || $check_action('/food_information/view','get') || $check_action('//table','add') || $check_action('//view','add')" >
