  ...
  <el-main class="bg edit_wrap comtable_e">
    ...
    >
      <el-row class="row_ce">
        ...
        >
          <el-form-item label="美食分类" prop="food_classification">
            ...
            >
              <el-option
                v-for="(o, index) in list_food_classification"
                :key="index"
        ...
        <el-col
          v-if="
            user_group === '管理员' ||
            $check_field('get', 'food_address') ||
            $check_field('add', 'food_address') ||
            $check_field('set', 'food_address')
          "
          :xs="24"
          :sm="12"
          :lg="8"
            ...
            <el-input
              ...
              v-if="
                ...
                (!form['food_information_id'] &&
                  $check_field('add', 'food_address'))
              "
              :disabled="disabledObj['food_address_isDisabled']"
            ></el-input>
            <div v-else-if="$check_field('get', 'food_address')">
              {{ form["food_address"] }}
            </div>
          </el-form-item>
        </el-col>
        <el-col
          v-if="
            user_group === '管理员' ||
            $check_field('get', 'food_labels') ||
            $check_field('add', 'food_labels') ||
            $check_field('set', 'food_labels')
          "
          :xs="24"
          :sm="12"
          :lg="8"
            ...
            <el-input
              ...
              v-if="
                ...
                (!form['food_information_id'] &&
                  $check_field('add', 'food_labels'))
              "
              :disabled="disabledObj['food_labels_isDisabled']"
            ></el-input>
            <div v-else-if="$check_field('get', 'food_labels')">
              {{ form["food_labels"] }}
            </div>
          </el-form-item>
        </el-col>
        <el-col
          v-if="
            user_group === '管理员' ||
            $check_field('get', 'food_pictures') ||
            $check_field('add', 'food_pictures') ||
            $check_field('set', 'food_pictures')
          "
          :xs="24"
          :sm="12"
          :lg="8"
        ...
        >
          <el-form-item label="美食图片" prop="food_pictures">
            <el-upload
              :disabled="disabledObj['food_pictures_isDisabled']"
              id="food_pictures"
              class="avatar-uploader"
              drag
              accept="image/gif, image/jpeg, image/png, image/jpg"
              action=""
              :http-request="upload_food_pictures"
            ...
            >
              <img
                v-if="form['food_pictures']"
                :src="$fullUrl(form['food_pictures'])"
                class="avatar"
              />
              <i v-else class="el-icon-plus avatar-uploader-icon"></i>
            </el-upload>
            <el-image
              v-else-if="$check_field('get', 'food_pictures')"
              style="width: 100px; height: 100px"
              :src="$fullUrl(form['food_pictures'])"
              :preview-src-list="[$fullUrl(form['food_pictures'])]"
            >
        ...
        <el-col
          v-if="
            user_group === '管理员' ||
            $check_field('get', 'introduction_to_food') ||
            $check_field('add', 'introduction_to_food') ||
            $check_field('set', 'introduction_to_food')
          "
          :xs="24"
          :sm="24"
          :lg="24"
        ...
        >
          <el-form-item label="美食简介" prop="introduction_to_food">
            <quill-editor
              v-model.number="form['introduction_to_food']"
              v-if="
                user_group === '管理员' ||
                (form['food_information_id'] &&
                  $check_field('set', 'introduction_to_food')) ||
            ...
            <div
              v-else-if="$check_field('get', 'introduction_to_food')"
              v-html="form['introduction_to_food']"
            ></div>
          </el-form-item>
        </el-col>
      </el-row>
      <el-col :xs="24" :sm="12" :lg="8" class="el_form_btn_warp">
        <el-form-item
          v-if="
            $check_action('/food_information/view', 'set') ||
            $check_action('/food_information/view', 'add') ||
            $check_option('/food_information/table', 'examine')
          "
        >
