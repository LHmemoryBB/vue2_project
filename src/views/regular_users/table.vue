  ...
  <el-main class="bg table_wrap comtabel_t">
        ...
        <el-col :xs="24" :sm="24" :lg="24" class="search_btn_wrap search_btns">
          ...
          >
            ...
            <el-button
              v-if="
                user_group == '管理员' ||
                $check_action('/regular_users/table', 'add') ||
            ...
            <el-button
              v-if="
                user_group == '管理员' ||
                $check_action('/regular_users/table', 'del') ||
                $check_action('/regular_users/view', 'del')
              "
    ...
    >
      ...
      <el-table-column
        ...
        @sort-change="$sortChange"
        label="用户性别"
        v-if="user_group == '管理员' || $check_field('get', 'user_gender')"
        min-width="200"
      ></el-table-column>
      <el-table-column
        prop="user_age"
        @sort-change="$sortChange"
        label="用户年龄"
        v-if="user_group == '管理员' || $check_field('get', 'user_age')"
        min-width="200"
      ></el-table-column>
      <el-table-column
        prop="user_points"
        @sort-change="$sortChange"
        label="用户积分"
        v-if="user_group == '管理员' || $check_field('get', 'user_points')"
        min-width="200"
      ></el-table-column>
      ...
      <el-table-column
        ...
        v-if="
          user_group == '管理员' ||
          $check_action('/regular_users/table', 'set') ||
          $check_action('/regular_users/view', 'set') ||
          $check_action('/regular_users/view', 'get') ||
          $check_action('/${table.tableConfig.table_nav_name}/table', 'add') ||
          $check_action('/${table.tableConfig.table_nav_name}/view', 'add')
        "
      >
        <template slot-scope="scope">
          <div class="view_a">
