    ...
    >
      <el-row class="row_ce">
        ...
        <el-col
          ...
          class="el_form_item_warp"
        >
          <el-form-item label="民宿链接" prop="homestay_room_type">
            <el-input
              id="homestay_room_type"
              v-model="form['homestay_link']"
              placeholder="请输入民宿链接"
              v-if="
                user_group === '管理员' ||
                (form['homestay_information_id'] &&
        ...
        <el-col
          v-if="
            user_group === '管理员' ||
            $check_field('get', 'number_of_rooms') ||
            $check_field('add', 'number_of_rooms') ||
            $check_field('set', 'number_of_rooms')
          "
          :xs="24"
          :sm="12"
          :lg="8"
            ...
            <el-input-number
              ...
              v-if="
                ...
                (!form['homestay_information_id'] &&
                  $check_field('add', 'number_of_rooms'))
              "
              :disabled="disabledObj['number_of_rooms_isDisabled']"
            ></el-input-number>
            <div v-else-if="$check_field('get', 'number_of_rooms')">
        ...
        >
          <el-form-item label="联系电话" prop="contact_phone_number">
            ...
            ></el-input>
            <div v-else-if="$check_field('get', 'contact_phone_number')">
        ...
        >
          <el-form-item label="民宿图片" prop="homestay_pictures">
            <el-upload
              :disabled="disabledObj['homestay_pictures_isDisabled']"
              id="homestay_pictures"
              class="avatar-uploader"
              drag
              accept="image/gif, image/jpeg, image/png, image/jpg"
              action=""
              :http-request="upload_homestay_pictures"
            ...
            <el-image
              ...
              :src="$fullUrl(form['homestay_pictures'])"
              :preview-src-list="[$fullUrl(form['homestay_pictures'])]"
            >
        ...
        <el-col
          v-if="
            user_group === '管理员' ||
            $check_field('get', 'homestay_introduction') ||
            $check_field('add', 'homestay_introduction') ||
            $check_field('set', 'homestay_introduction')
          "
          :xs="24"
          :sm="24"
          :lg="24"
        ...
        >
          <el-form-item label="民宿简介" prop="homestay_introduction">
            <quill-editor
              v-model.number="form['homestay_introduction']"
              v-if="
                user_group === '管理员' ||
                (form['homestay_information_id'] &&
                  $check_field('set', 'homestay_introduction')) ||
            ...
            <div
              v-else-if="$check_field('get', 'homestay_introduction')"
              v-html="form['homestay_introduction']"
            ></div>
          </el-form-item>
        </el-col>
      </el-row>
